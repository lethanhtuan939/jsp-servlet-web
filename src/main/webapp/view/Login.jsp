...
<link rel="stylesheet"
	...
	crossorigin="anonymous">
<link href="/Project_Sale_Servlet/css/login.css" rel="stylesheet"
	type="text/css" />
<title>Login Form</title>
</head>
<body>
	<div id="logreg-forms">
		<form class="form-signin" action="/Project_Sale_Servlet/LoginServlet" method="post">
			<h1 class="h3 mb-3 font-weight-normal" style="text-align: center">
				Sign in</h1>
			<p class="text-danger">${message}</p>

			<input name="user" value="${user}" type="text" id="inputEmail" class="form-control"
				placeholder="Username" required="" autofocus=""> 
			<input name="password" value="${password}" type="password" id="inputPassword" class="form-control"
		...
		<form action="/Project_Sale_Servlet/SignupServlet" method="post" class="form-signup">
			<h1 class="h3 mb-3 font-weight-normal" style="text-align: center">
				Sign up</h1>
