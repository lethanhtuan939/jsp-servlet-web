...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	<div class="container">
		<a class="navbar-brand" href="HomeServlet">Shoes</a>
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav m-auto">
				<c:if test="${sessionScope.acc.isSell == 1}">
					<li class="nav-item"><a class="nav-link" href="ManagerProductServlet">Manager
							Product</a></li>			
				</c:if>
				...
				<c:if test="${sessionScope.acc != null}">
					...
					<li class="nav-item"><a class="nav-link"
						href="/Project_Sale_Servlet/LogoutServlet">Logout</a></li>
				</c:if>
				<c:if test="${sessionScope.acc == null}">
					<li class="nav-item"><a class="nav-link"
			...
			<form action="SearchServlet" method="post"
				...
				<div class="input-group input-group-sm">
					<input oninput="searchByName(this)" value="${txtSearch}" name="searchTxt" type="text"
...
<section class="jumbotron text-center">
	<div class="container">
		...
		<p class="lead text-muted mb-0">Uy tín tạo nên thương hiệu với hơn
			10 năm cung cấp các sản phầm giày nhập từ Việt Nam</p>
	</div>
</section>
<!--end of menu-->