...
<html lang="en">
    <head>
        ...
        <link href="/Project_Sale_Servlet/css/manager.css" rel="stylesheet" type="text/css"/>
        <style>
            img{
                width: 200px;
                height: 120px;
    ...
    <body>
        <div class="container">
            ...
            <a href="HomeServlet"><button type="button" class="btn btn-primary">Back to home</button>
    ...
    <script src="/Project_Sale_Servlet/js/manager.js" type="text/javascript"></script>
</body>
</html>